...
impl Preview {
    pub fn new(text: Text<'static>, line_number: Option<i32>) -> Preview {
...
impl PreviewJob {
    pub fn new(file_path: &str, line_number: Option<i32>) -> PreviewJob {
    ...
    pub fn try_recv_preview(&self) -> Option<Preview> {
        ...
        match maybe_output {
            Some(output) => match output.into_text() {
                ...
                _ => Some(Preview::new(Text::raw("Error in parsing preview"), None)),
            },
            None => Some(Preview::new(Text::raw("Error in bat"), None)),
        }
    }

    fn build_command(file_path: &str, line_number: Option<i32>) -> Command {
